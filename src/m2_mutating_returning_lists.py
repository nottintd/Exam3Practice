...
def run_test_doubler():
    ...
    # ------------------------------------------------------------------
    # Test 1:
    arg1 = [120, -33, 220, 54, 403, 0, 2, 5]
    arg2 = [23, -7, 8, 45, 4, 6, -8]
    correct_arg1_after = [240, -66, 440, 108, 806, 0, 4, 10]
    correct_arg2_after = [23, -7, 8, 45, 4, 6, -8]
    expected = [46, -14, 16, 90, 8, 12, -16]
